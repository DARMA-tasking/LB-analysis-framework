...
class TestConfig(unittest.TestCase):
    def setUp(self):
        ...
        self.rank_list = [Rank(i=0, mo={Object(i=3, load=0.5, r_id=0, c=ObjectCommunicator(i=3, logger=self.logger,
                                                                                     s={Object(i=2, load=0.5): 1.0,
                                                                                        Object(i=8, load=1.5): 0.5})),
                                        Object(i=2, load=0.5, r_id=0, c=ObjectCommunicator(i=2, logger=self.logger,
                                                                                     r={Object(i=3, load=0.5): 1.0})),
                                        Object(i=0, load=1.0, r_id=0, c=ObjectCommunicator(i=0, logger=self.logger,
                                                                                     s={Object(i=5, load=2.0): 2.0})),
                                        Object(i=1, load=0.5, r_id=0, c=ObjectCommunicator(i=1, logger=self.logger,
                                                                                     r={Object(i=4, load=0.5): 2.0},
                                                                                     s={Object(i=4, load=0.5): 1.0}))},
                               logger=self.logger),
                          Rank(i=1, mo={Object(i=5, load=2.0, r_id=1, c=ObjectCommunicator(i=5, logger=self.logger,
                                                                                     r={Object(i=0, load=1.0): 2.0},
                                                                                     s={Object(i=8, load=1.5): 2.0})),
                                        Object(i=7, load=0.5, r_id=1, c=ObjectCommunicator(i=7, logger=self.logger,
                                                                                     s={Object(i=6, load=1.0): 1.0})),
                                        Object(i=6, load=1.0, r_id=1, c=ObjectCommunicator(i=6, logger=self.logger,
                                                                                     r={Object(i=7, load=0.5): 1.0,
                                                                                        Object(i=8, load=1.5): 1.5})),
                                        Object(i=4, load=0.5, r_id=1, c=ObjectCommunicator(i=4, logger=self.logger,
                                                                                     r={Object(i=1, load=0.5): 1.0},
                                                                                     s={Object(i=1, load=0.5): 2.0}))},
                               logger=self.logger),
                          Rank(i=2, mo={Object(i=8, load=1.5, r_id=2, c=ObjectCommunicator(i=8, logger=self.logger,
