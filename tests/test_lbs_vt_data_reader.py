...
class TestConfig(unittest.TestCase):
    def setUp(self):
        ...
        self.rank_list = [Rank(i=0, mo={Object(i=3, t=0.5, p=0, c=ObjectCommunicator(i=3,
                                                                                     s={Object(i=2, t=0.5): 1.0,
                                                                                        Object(i=8, t=1.5): 0.5})),
                                        Object(i=2, t=0.5, p=0, c=ObjectCommunicator(i=2, r={Object(i=3, t=0.5): 1.0})),
                                        Object(i=0, t=1.0, p=0, c=ObjectCommunicator(i=0, s={Object(i=5, t=2.0): 2.0})),
                                        Object(i=1, t=0.5, p=0, c=ObjectCommunicator(i=1, r={Object(i=4, t=0.5): 2.0},
                                                                                     s={Object(i=4, t=0.5): 1.0}))},
                               logger=self.logger),
                          Rank(i=1, mo={Object(i=5, t=2.0, p=1, c=ObjectCommunicator(i=5, r={Object(i=0, t=1.0): 2.0},
                                                                                     s={Object(i=8, t=1.5): 2.0})),
                                        Object(i=7, t=0.5, p=1, c=ObjectCommunicator(i=7, s={Object(i=6, t=1.0): 1.0})),
                                        Object(i=6, t=1.0, p=1, c=ObjectCommunicator(i=6, r={Object(i=7, t=0.5): 1.0,
                                                                                             Object(i=8, t=1.5): 1.5})),
                                        Object(i=4, t=0.5, p=1, c=ObjectCommunicator(i=4, r={Object(i=1, t=0.5): 1.0},
                                                                                     s={Object(i=1, t=0.5): 2.0}))},
                               logger=self.logger),
                          Rank(i=2, mo={Object(i=8, t=1.5, p=2, c=ObjectCommunicator(i=8, r={Object(i=3, t=0.5): 0.5,
