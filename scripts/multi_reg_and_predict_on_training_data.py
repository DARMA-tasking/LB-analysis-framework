...
# This script trains on in.*.dat in the working directory and then predicts
...
# Iterate over input files with names matching in.*.dat
files = glob.glob("./in.*.dat")
setupRegressors(files, bool_cols, y_col, rank_col, excluded, X, Y, ranks, regressor_list, n_obs)
