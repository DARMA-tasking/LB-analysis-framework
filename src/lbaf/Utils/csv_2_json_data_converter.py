...
class Csv2JsonConverter:
    """ A class to convert from previous log structure (CSV) to a current log structure (JSON)
        ...
        Files for conversion should be named as follows 'prefix.rank/node.extension' e.g. 'data.0.json', 'data.1.json'
        ...
        :param in_file_extension: Input file extension, e.g. '.json'
